# Generated by Django 5.1.4 on 2025-06-06 06:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activities', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.activity', verbose_name='actividades')),
                ('schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.schedule', verbose_name='horario')),
        ...
        migrations.AddConstraint(
            model_name='period',
            constraint=models.CheckConstraint(check=models.Q(start__week_day__gt=1), name='check_start_period_not_sunday', violation_error_message='La fecha de inicio no puede ser domingo'),
        ),
        migrations.AddConstraint(
            model_name='period',
            constraint=models.CheckConstraint(check=models.Q(end__week_day__gt=1), name='check_end_period_not_sunday', violation_error_message='La fecha de fin no puede ser domingo'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name='daynotavailable',
            constraint=models.CheckConstraint(check=models.Q(day__week_day__gt=1), name='check_day_not_available_not_sunday', violation_error_message='El día no puede ser domingo'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name='classtime',
            constraint=models.CheckConstraint(check=models.Q(day__week_day__gt=1), name='check_day_not_sunday', violation_error_message='El día no puede ser domingo'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name='year',
            constraint=models.UniqueConstraint(fields=('number', 'career', 'course'), name='unique_year'),
        ),
        migrations.AddConstraint(
            model_name='subject',
